...
export const UpdatePasswordSchema = z.object({
        currentPassword: z.string().min(1, { message: 'El Password no puede ir vacio' }),
...
//dugets and expenses
export const DrfatExpenseSchema = z.object({
...
export type DrfatExpense = z.infer<typeof DrfatExpenseSchema>
