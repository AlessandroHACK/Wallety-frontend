          ...
          <MenuItems className="absolute right-0 z-10 mt-2 w-56 origin-top-right rounded-md bg-black border  py-2 shadow-lg ring-1 ring-gray-900/5 focus:outline-none">
            <MenuItem>
              <Link
                ...
                className='block px-3 py-1 text-sm leading-6 text-white hover:bg-gradient-to-r hover:from-[#2a2a2a] hover:to-[#1c1c1c]'
              >
                Ver Presupuesto
              </Link>
            </MenuItem>
            ...
            <MenuItem>
              <button
                type='button'
                className='block px-3 py-1 text-sm leading-6 text-red-500 hover:bg-gradient-to-r hover:from-[#2a2a2a] hover:to-[#1c1c1c]'
